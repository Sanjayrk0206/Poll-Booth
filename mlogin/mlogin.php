                ...
                if($result && mysqli_num_rows($result) > 0)
                {
                    ...
                    if(password_verify($Password,$user_data['Password']))
                    {
                        if($user_data['Designation'] === "Admin"){
                            ...
                            header("Location: ../Admin Page/mainpage.php",true);
                            die;
                        }else{
                            $Notice="You're not an Admin";
                        }
                    }else{
...
<html>
    <head>
        <title>Delta Manager Login</title>
    ...
    <body>
        ...
        <section class="welcome">
            <div class="login">
                <label class="Head"><span style="color: limegreen;">A</span>dmin <span style="color: limegreen;">L</span>ogin</label>
